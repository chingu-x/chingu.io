import type { TestimonialCard as TestimonialCardType } from "#/types/content/testimonial.ts";
		...
		<Card className="p-6 shadow-md bg-linear-to-b from-white to-foreground-100 max-w-205">
			...
			<div className="flex items-center gap-4">
				...
				<div className="flex flex-col">
					<strong className="text-sm font-bold">{testimonial.name}</strong>
					<span className="uppercase text-2xs text-neutral font-bold">
						{testimonial.role}
					</span>
				</div>
			</div>
